module ActivityNotification
  ...
  module NotificationApi
    ...
    class_methods do
      ...
      # @option options [Boolean]                 :publish_action_cable     (true)                                Whether it publishes notification to ActionCable channel
      ...
      def notify_to(target, notifiable, options = {})
        if options[:notify_later]
          ...
          publish_action_cable     = options.has_key?(:publish_action_cable)     ? options[:publish_action_cable]     : true
          ...
          # Publish to ActionCable subscribers
          if notification.present? && publish_action_cable
            ...
            notification.publish_to_action_cable_channel(action_cable_rendering_options)
          end
    ...
    def publish_to_action_cable_channel(params = {})
