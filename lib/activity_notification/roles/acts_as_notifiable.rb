module ActivityNotification
  ...
  module ActsAsNotifiable
    ...
    class_methods do
      ...
      # @option options [Symbol, Proc, Boolean] :action_cable_enabled    (ActivityNotification.config.action_cable_enabled) Whether activity_notification publishes WebSocket using ActionCable
