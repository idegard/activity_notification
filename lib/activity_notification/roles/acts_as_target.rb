module ActivityNotification
  ...
  module ActsAsTarget
    ...
    class_methods do
      ...
      # @option options [Symbol, Proc, Boolean] :action_cable_enabled  (ActivityNotification.config.action_cable_enabled) Whether activity_notification publish WebSocket using ActionCable to this target
      ...
      def acts_as_target(options = {})
        ...
        acts_as_params = set_acts_as_parameters([:email, :email_allowed, :subscription_allowed, :action_cable_allowed, :devise_resource, :current_devise_target], options, "notification_")
      ...
      def available_target_options
        [:email, :email_allowed, :batch_email_allowed, :subscription_allowed, :action_cable_enabled, :devise_resource, :printable_notification_target_name, :printable_name].freeze
      end
    end
  end
end
